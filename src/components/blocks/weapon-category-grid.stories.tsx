...
const gridWidth = (category: string) => resolveWeaponCategoryWidth(category, 'grid');
const listWidth = (category: string) => resolveWeaponCategoryWidth(category, 'list');
    ...
    items: [
      {
        ...
        widthPercent: gridWidth(SIDEARM),
      },
      {
        key: 'shorty',
    ...
    items: [
      {
        ...
        widthPercent: gridWidth(SHOTGUN),
      },
      {
        key: 'judge',
